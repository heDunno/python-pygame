...
# tube 2
tube_surf_top2 = pygame.Surface((50, ran_tube_size2))
tube_rect_top2 = tube_surf_top2.get_rect(midtop=(600, 0))
tube_surf_top2.fill('Green')

tube_surf_bottom2 = pygame.Surface((50, ran_tube_size))
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if not isAlive and event.key == pygame.K_SPACE:
                ...
                tube_surf_bottom = pygame.Surface((50, ran_tube_size2))
                tube_rect_bottom = tube_surf_bottom.get_rect(
                    midbottom=(350, 400))
                tube_surf_bottom.fill('Green')
                ...
                tube_surf_bottom2 = pygame.Surface((50, ran_tube_size))
                tube_rect_bottom2 = tube_surf_bottom2.get_rect(
                    midbottom=(600, 400))
                tube_surf_bottom2.fill('Green')
    ...
    if isAlive:
        ...
        death_screen3 = font2.render(
            f'High Score: {highest_score}', False, 'Red')

        death_rect2 = death_screen2.get_rect(center=(250, 250))
        death_rect3 = death_screen3.get_rect(center=(250, 200))

        death_rect = death_screen.get_rect(center=(250, 150))
        ...
        screen.blit(death_screen3, death_rect3)
